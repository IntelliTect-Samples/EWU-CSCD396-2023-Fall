...
$appId = "1143c8fb-940a-4e5c-9f13-526356c0277e"; #the app ID created and granted permissions
$appSecret = "rjG8Q~KsmY.w6NCz0SzbTl._3ZxMTO5kCI_7IaZs"; #the secret created for the above app - never store your secrets in the source code
##### >>>> END <<<<<
