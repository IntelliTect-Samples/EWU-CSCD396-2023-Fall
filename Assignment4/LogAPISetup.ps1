...
#----------------------------------------------------------------------------
$TenantId                              = "b2faa120-054d-4db6-bd47-17f409b3fa91"
...
$LogAnalyticsSubscription              = "4b0e8ef1-c58c-47af-a570-74e48f584391"
$LogAnalyticsResourceGroup             = "Assignment4"
$LoganalyticsWorkspaceName             = "log-analytics-a4"
$LoganalyticsLocation                  = "westus"
