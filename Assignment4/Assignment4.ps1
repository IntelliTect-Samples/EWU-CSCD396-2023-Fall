...
# - Az.OperationalInsights 3.2.0
 ...
 $ResourceGroup = "rg4"
 $LogAnalyticsWorkspaceName = "r4workspace"
 $LogAnalyticsTableName = "r4Table_CL"
 $DataCollectionRuleName = "rgDCR"
 $DataCollectionEndpointName = "rgDCE"
 $FunctionAppName = "Assignment4BeighlorM"
 $ApiManagementGatewayName = "rg4APIM"
